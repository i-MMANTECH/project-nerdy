...
import { createUserAction, loadDealersForResellerAction } from "@/actions/forms";
...
export function NewUserForm({ resellers, tariffs, validityOptions, customPlanId, addonPackages }: Props) {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl">
      ...
      <form action={createUserAction} className="w-full">
        <div className="flex flex-col gap-8 sm:gap-10">
          <section>
            <SectionTitle>Account</SectionTitle>
            <div className={cn(grid)}>
              <FormField id="nu-name" label="Name">
                <Input id="nu-name" name="name" placeholder="Display name" />
              </FormField>
              <FormField
                id="nu-username"
              ...
              <FormField id="nu-password" label="Password" hint="Minimum 4 characters.">
                <Input
                  id="nu-password"
                  name="password"
                  type="text"
              ...
              <FormField id="nu-mac" label="MAC address">
                <MacAddressInput id="nu-mac" name="mac" required className="font-mono uppercase" placeholder="00:1A:79:00:00:01" />
              </FormField>
            </div>
          </section>
          ...
          <section className="border-t border-border/60 pt-8 sm:pt-10">
            ...
            <div className={cn(grid)}>
              <FormField id="nu-validity" label="Validity">
                <FormSelect
                  id="nu-validity"
                  name="validity"
                  required
              ...
              <FormField id="nu-status" label="Status">
                <FormSelect
                  id="nu-status"
                  name="status"
                  defaultValue="0"
          ...
          <section className="border-t border-border/60 pt-8 sm:pt-10">
            ...
            <div className={cn(grid)}>
              <FormField id="nu-reseller" label="Reseller">
                <FormSelect
                  id="nu-reseller"
                  name="reseller"
                  required
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-border/60 pt-6 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end sm:gap-3">
            <Link href="/admin/users" className={buttonOutlineLinkClassName("min-h-11 w-full justify-center sm:w-auto")}>
              Cancel
            </Link>
