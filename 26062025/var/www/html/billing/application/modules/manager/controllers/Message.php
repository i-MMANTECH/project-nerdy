...
class Message extends ManagerController {
    ...
    public function index() {
        ...
        $sql = $this->manager_model->get_all_users($this->user['username']);
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($type == 'All') {
                ...
                foreach ($users_cs as $usd) {
                    if ($this->manager_model->is_myuser($usd, $this->user['username']) == true) {
                        $insert_Data = array(
