    ...
    <div class="page-header-content">
        ...
        <div class="heading-elements">
            <div class="heading-btn-group">
                <a href="<?= site_url('manager/dealers/index'); ?>" class="btn btn-danger btn-sm"> <i class=" icon-circle-left2"></i> BACK </a>
            </div>
        </div>
    </div>
</div>

<?php $limitCredit = $this->configs_model->find('limit_dealer_credit')->value ?? 2000 ;?>
<!-- /page header -->
<!-- Page container -->
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-3">
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('manager/dealers/edit/'.$row->username,array('class'=>'form-horizontal','id'=>'form_sample_3'));?>
         ...
         <?php $resellers_sql = $this->db->where(array('username_owner'=>$auth_info['username'],'type'=>'SRSLR'))->get('users')->result();?>
                                        <?php foreach($resellers_sql as $reseller):?>
                                        <option value="<?= $reseller->username; ?>" <?=  ($reseller->username == $row->username_owner) ? 'selected="selected"':''; ?>> <?= $reseller->username; ?> </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group text-center">
                                ...
                                <a class="btn btn-sm btn-danger" href="<?= site_url('manager/resellers/index'); ?>" ><i class="icon-blocked"></i> Cancel </a>
                            </div>
                            <?php echo form_close();?>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            <?php elseif($trans->type=='DBIT' && empty($trans->account)): ?>
    ...
    <div class="modal fade" id="myModalAdd" role="dialog" aria-labelledby="myModalLabel" style="top: 40%;">
        <div class="modal-dialog" role="document">
            <div div class="modal-content">
                <?= form_open('manager/dealers/transactions/'.$row->username,array('class'=>'form-horizontal'));?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="credits">
                                    <?php for ($i=$limitCredit; $i <=5000 ; $i++) {
