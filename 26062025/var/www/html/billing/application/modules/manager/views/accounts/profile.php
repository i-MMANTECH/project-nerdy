    ...
    <div class="content-wrapper">
      ...
      <div class="panel panel-flat col-md-7 col-md-offset-2">
        ...
        <div class="panel-body">
          <!-- BEGIN FORM-->
          <?php echo form_open('manager/profile/',array('class'=>'form-horizontal','id'=>'form_sample_3'));?>
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-md-offset-4 col-md-9">
                ...
                <a class="btn btn-sm btn-danger" href="<?= site_url('manager/dashboard'); ?>" ><i class="icon-blocked"></i> Cancel </a>
              </div>
            </div>
          </div>
        </form>
