    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-flat">
          ...
          <div class="panel-body">
            <!-- BEGIN FORM-->
            <?php echo form_open('manager/users/edit/' . $row->account, array('class' => 'form-horizontal', 'id' => 'form_sample_3')); ?>
            ...
            <div class="form-actions">
              <div class="row">
                <div class="col-md-offset-3 col-md-9">
                  <button type="submit" class="btn btn-sm btn-success"><i class="icon-floppy-disk"></i> SEND</button>
