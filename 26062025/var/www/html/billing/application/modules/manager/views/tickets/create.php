	...
	<div class="page-header-content">
		...
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="<?= site_url('manager/index'); ?>" class="btn btn-danger btn-sm"> <i class=" icon-circle-left2"></i> BACK </a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="content-wrapper">
			...
			<div class="panel panel-flat">
				...
				<div class="panel-body">
					...
					<?php echo form_open('manager/tickets/create',array('class'=>'form-horizontal','id'=>'form_sample_3'));?>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<a class="btn btn-sm btn-danger" href="<?= site_url('manager/tickets/index'); ?>" ><i class="icon-blocked"></i> Cancel </a>
							</div>
						</div>
					</div>
					</form>
