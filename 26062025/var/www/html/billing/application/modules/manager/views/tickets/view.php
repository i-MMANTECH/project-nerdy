	...
	<div class="page-header-content">
		<div class="page-title">
			...
			<ul class="breadcrumb breadcrumb-caret position-right">
				<li><a href="<?= site_url('manager/dashboard'); ?>">Home</a></li>
				<li class="active"><?php echo $module; ?></li>
			</ul>
		</div>
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="<?= site_url('manager/tickets/index'); ?>" class="btn btn-danger btn-sm"> <i class=" icon-circle-left2"></i> BACK </a>
			</div>
		</div>
	</div>
</div>
									...
									<div class="card-body">
										...
										<?php if($data->status_id==2 && $tickets_enabled==0) { ?>
											<div class="row">
												<div class="col-lg-12 mb20">
													...
													<?php echo form_open(site_url('manager/tickets/reopen'),$attr);?>
										...
										<?php if($data->status_id!=2 && $tickets_enabled==0) { ?>
											<div class="row">
												<div class="col-lg-12 mb20">
													<?php $attr = array('class'=>'form-horizontal bs-example','role'=>'form');?>
													<?php echo form_open(site_url('manager/tickets/markcomplete'),$attr);?>
													<input type="hidden" name="subject" value="<?php echo $data->subject; ?>">
													<input type="hidden" name="redirect" value="<?php echo base64_encode($data->id); ?>">
													<input type="hidden" name="ticket_id" value="<?php echo base64_encode($data->id); ?>">
										...
										<?php if($tickets_enabled==1) { ?>
											<div class="row">
												<div class="col-lg-12 mb20">
													...
													<div class="modal fade" id="edit-ticket-modal" tabindex="-1" role="dialog" aria-labelledby="edit-ticket-modal" aria-hidden="true">
														<div class="modal-dialog" role="document">
															<div class="modal-content">
																...
																<?php $attr = array('class'=>'form-horizontal bs-example','role'=>'form');?>
																<?php echo form_open(site_url('manager/tickets/updateticket'),$attr);?>
													...
													<?php $attr = array('class'=>'form-horizontal bs-example','role'=>'form');?>
													<?php echo form_open(site_url('manager/tickets/delete'),$attr);?>
													<input type="hidden" name="subject" value="<?php echo $data->subject; ?>">
													<input type="hidden" name="redirect" value="<?php echo base64_encode($data->id); ?>">
													<input type="hidden" name="ticket_id" value="<?php echo base64_encode($data->id); ?>">
						...
						<div class="row">
							<div class="col-md-12" style="margin-top: 30px;">
								<div class="card mb-3">
									<div class="card-body">
										<?php $attr = array('class'=>'form-horizontal bs-example','role'=>'form');?>
										<?php echo form_open(site_url('manager/tickets/comment'),$attr);?>
...
<script>
	...
	{
		if(findNumber==false) {
			var url = '/index.php/manager/tickets/channels';
			$.ajax({
				type: 'GET',
				url: url,
				async: true,
	...
	{
		findNumber = true;
		var url = '/index.php/manager/tickets/channel_category_and_id';
		$.ajax({
			type: 'GET',
			url: url,
			async: true,
