<div class="page-content">
  ...
  <div class="page-bar">
    ...
    <div class="page-toolbar">
      <div class="btn-group">
        <a class="btn red-thunderbird" href="<?= site_url('manager/resellers/index'); ?>" ><i class="fa fa-arrow-left"></i> BACK </a>
              ...
              <div class="form-actions">
                <div class="row">
                  <div class="col-md-offset-3 col-md-9">
                   ...
                   <a class="btn red-thunderbird" href="<?= site_url('manager/resellers/index'); ?>" ><i class="fa fa-ban"></i> Cancel </a>
                  </div>
                </div>
              </div>
            </form>
