...
<?php $limitCredit = $this->configs_model->find('limit_reseller_credit')->value ?? 1 ;?>
<!-- /page header -->
<!-- Page container -->
                ...
                <div class="col-md-3">
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('manager/resellers/edit/'.$row->username,array('class'=>'form-horizontal','id'=>'form_sample_3'));?>
    ...
    <div class="modal fade" id="myModalAdd" role="dialog" aria-labelledby="myModalLabel" style="top: 40%;">
        <div class="modal-dialog" role="document">
            <div div class="modal-content">
                <?= form_open('manager/resellers/transactions/'.$row->username,array('class'=>'form-horizontal'));?>
