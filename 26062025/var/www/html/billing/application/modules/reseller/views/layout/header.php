    ...
    <div class="page-header-inner ">
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                 <li><a href="<?= site_url('reseller/transactions') ?>"><span class="label-danger label"> <i class="fa fa-money"></i> <?= $this->transaction_model->get_credit_balance($auth_info['username']); ?> Credits Remaining</span></a></li>
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="<?=site_url('reseller/profile');?>">
                        ...
                        <li>
                            <a href="<?=site_url('reseller/logout');?>">
