...
<?php $limitCredit = $this->configs_model->find('limit_dealer_credit')->value ?? 1 ;?>
<!-- /page header -->
<!-- Page container -->
                ...
                <div class="col-md-3">
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('reseller/dealers/edit/'.$row->username,array('class'=>'form-horizontal','id'=>'form_sample_3'));?>
                            ...
                            <table class="table  datatable-responsive" id="sample_1">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?=  $trans->remarks;?> <?= !empty($trans->created_by) ? 'by '.$trans->created_by : ''; ?></td>
    ...
    <div class="modal fade" id="myModalAdd" role="dialog" aria-labelledby="myModalLabel" style="top: 40%;">
        <div class="modal-dialog" role="document">
            <div div class="modal-content">
                <?= form_open('reseller/dealers/transactions/'.$row->username,array('class'=>'form-horizontal'));?>
