...
<html lang="en">
  <head>
    ...
    <script type="text/javascript"> var SiteURL = "<?php echo site_url('reseller'); ?>";</script>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse">
      <div class="navbar-header">
        <a class="navbar-brand" href="<?=site_url('reseller/dashboard');?>"><?php $top_remain_crdt = $this->transaction_model->get_credit_balance($auth_info['username']);?>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown dropdown-user">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
              <li><a href="<?=site_url('reseller/profile');?>"><i class="icon-user-plus"></i> My profile</a></li>
              <li><a href="<?=site_url('reseller/logout');?>"><i class="icon-switch2"></i> Logout</a></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div class="navbar navbar-default" id="navbar-second">
      ...
      <div class="navbar-collapse collapse" id="navbar-second-toggle">
        <ul class="nav navbar-nav">
          ...
          <li class="<?=($active_uri == 'dashboard') ? 'active' : '';?>"><a href="<?=site_url('reseller/dashboard');?>"><i class="icon-display4 position-left"></i> Dashboard</a></li>
       
       
          <li class="<?=($active_uri == 'dealers') ? 'active ' : '';?> ">
            <a href="<?php echo site_url('reseller/dealers/index'); ?>" >
              <i class="icon-users2 position-left"></i>
              Dealers
            </a>
          </li>
          <li class=" <?=($active_uri == 'users') ? 'active ' : '';?>">
            <a href="<?php echo site_url('reseller/users/index'); ?>" >
              <i class="icon-users4 position-left"></i>
              Users
            </a>
          </li>
          <li class="<?=($active_uri == 'message') ? 'active ' : '';?>">
            <a href="<?php echo site_url('reseller/message'); ?>" >
              <i class="icon-envelope position-left"></i>
              Message
              <!-- <span class="selected"></span> -->
            </a>
          </li>
         <li class="<?=($active_uri == 'transactions') ? 'active' : '';?>"><a href="<?=site_url('reseller/transactions');?>"><i class="icon-coins position-left"></i> Transactions </a></li>
         <li class="<?=($active_uri == 'check_mac') ? 'active' : '';?>"><a href="<?=site_url('reseller/check_mac');?>"><i class="icon-server position-left"></i> Check MAC </a></li>
        </ul>
        <div class="col-sm-3 col-md-3 navbar-right">
          <?php echo form_open('reseller/users/index', array('class' => 'navbar-form navbar-right', 'method' => 'get')); ?>
