<div class="page-content">
  ...
  <div class="page-bar">
    ...
    <div class="page-toolbar">
      <div class="btn-group">
        <a class="btn red-thunderbird" href="<?= site_url('reseller/dealers/index'); ?>" ><i class="fa fa-arrow-left"></i> BACK </a>
      </div>
    </div>
  </div>
  <!-- END PAGE BAR -->
        ...
        <div class="portlet-body">
          ...
          <div class="form-group">
            <div class="col-md-3 col-md-offset-5">
              ...
              <a class="btn red-thunderbird" href="<?= site_url('reseller/dealers/index'); ?>" ><i class="fa fa-ban"></i> Cancel </a>
            </div>
          </div>
          <?= form_close();?>
        </div>
