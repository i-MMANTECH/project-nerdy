						...
						<div class="card">
							<div class="card-body">
								...
								<div class="col-md-12 mb20">
									<div class="col-md-12">
										<a href="<?php echo site_url('admin/tickets/create'); ?>">
									...
									<div class="col-md-12" style="margin-top: 20px;">
										...
										<div class="col-12" style="margin-top: 20px; margin-bottom: 20px;">
											...
											<a href="<?php echo site_url('admin/tickets/complete'); ?>">
											...
											<table id="order-listing" class="table">
												...
												foreach($sql->result() as $data) {?>
													<tr>
														...
														<td><a href="<?php echo site_url('admin/tickets/view').'/'.base64_encode($data->id); ?>"><?php echo $data->subject; ?></a></td>
