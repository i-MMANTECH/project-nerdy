...
<?php $limitCredit = $this->configs_model->find('limit_reseller_credit')->value ?? 2000 ;?>
<!-- /page header -->
<!-- Page container -->
                ...
                <div class="col-md-3">
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('admin/resellers/edit/'.$row->username,array('class'=>'form-horizontal','id'=>'form_sample_3'));?>
                            ...
                            <div class="form-group last <?= (form_error('manager')) ? 'has-error' : '' ; ?>">
                                <label for="inputPassword9" class="">Manager</label>
                                <select class="form-control" name="manager">
                                    <option value="" <?= (empty($row->username_owner)) ? 'selected="selected"':''; ?> >[Select Manager]</option>
                                       <?php $managers =$this->manager_model->get_all();?>
                                    <?php foreach($managers->result() as $manager):?>
                                    <option  value="<?= $manager->username; ?>" <?= ($row->username_owner==$manager->username) ? 'selected="selected"':''; ?> ><?= $manager->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
    ...
    <div class="modal fade" id="myModalAdd" role="dialog" aria-labelledby="myModalLabel" style="top: 40%;">
        <div class="modal-dialog" role="document">
            <div div class="modal-content">
                <?= form_open('admin/resellers/transactions/'.$row->username,array('class'=>'form-horizontal'));?>
