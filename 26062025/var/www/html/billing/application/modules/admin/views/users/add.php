        ...
        <div class="panel-body">
          ...
          <div class="form-body">
            ...
            <div class="form-group <?= (form_error('mac')) ? 'has-error' : '' ; ?>">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control inputmask" id="mac_mask"  name="mac" placeholder="00:1A:79:__:__:__" maxlength="17" value="<?= set_value('mac');?>"/>
            ...
            <div class="form-group last <?= (form_error('reseller')) ? 'has-error' : '' ; ?>">
              ...
              <div class="col-sm-3">
                <select class="form-control" name="reseller" id="reseller_drop" onchange="getDealer();">
                  <option value="" <?= set_select('reseller', '', (set_value('reseller') === '') ? TRUE : FALSE); ?>>Select Reseller</option>
                  <?php foreach($resellers as $reseller):?>
                    <option value="<?= $reseller->username; ?>" <?= set_select('reseller', $reseller->username); ?>> <?= $reseller->username; ?> </option>
                  <?php endforeach; ?>
                </select>
