...
<html lang="en">
  <head>
    ...
    <script type="text/javascript"> var SiteURL = "<?php echo site_url('dealer'); ?>";</script>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse">
      <div class="navbar-header">
        <a class="navbar-brand" href="<?=site_url('dealer/dashboard');?>"><?php $top_remain_crdt = $this->transaction_model->get_credit_balance($auth_info['username']);?>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown dropdown-user">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
              <li><a href="<?=site_url('dealer/profile');?>"><i class="icon-user-plus"></i> My profile</a></li>
              <li><a href="<?=site_url('dealer/logout');?>"><i class="icon-switch2"></i> Logout</a></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div class="navbar navbar-default" id="navbar-second">
      ...
      <div class="navbar-collapse collapse" id="navbar-second-toggle">
        <ul class="nav navbar-nav">
          ...
          <li class="<?=($active_uri == 'dashboard') ? 'active' : '';?>"><a href="<?=site_url('dealer/dashboard');?>"><i class="icon-display4 position-left"></i> Dashboard</a></li>
       
        
          <li class=" <?=($active_uri == 'users') ? 'active ' : '';?>">
            <a href="<?php echo site_url('dealer/users/index'); ?>" >
              <i class="icon-users4 position-left"></i>
              Users
            </a>
          </li>
          <li class="<?=($active_uri == 'message') ? 'active ' : '';?>">
            <a href="<?php echo site_url('dealer/message'); ?>" >
			...
			<li class="<?=($active_uri == 'tickets') ? 'active ' : '';?>">
				<a href="<?php echo site_url('dealer/tickets'); ?>" >
					<i class="icon-envelope position-left"></i>
					Tickets
					<!-- <span class="selected"></span> -->
				</a>
			</li>
			<li class="<?=($active_uri == 'transactions') ? 'active' : '';?>"><a href="<?=site_url('dealer/transactions');?>"><i class="icon-coins position-left"></i> Transactions </a></li>
         <li class="<?=($active_uri == 'check_mac') ? 'active' : '';?>"><a href="<?=site_url('dealer/check_mac');?>"><i class="icon-server position-left"></i> Check MAC </a></li>
        </ul>
        <div class="col-sm-3 col-md-3 navbar-right">
          <?php echo form_open('dealer/users/index', array('class' => 'navbar-form navbar-right', 'method' => 'get')); ?>
