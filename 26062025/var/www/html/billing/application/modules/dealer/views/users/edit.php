...
$( document ).ready(function() { 
    ...
    $('.btn-pre-transaction').click(function () {
        ...
        if (valChecked == 'RCDT') {
            ...
            let url = '/index.php/dealer/users/preCheckRenewal';
    ...
    $.get("<?= site_url('dealer/users/get_packages') ?>", function(data) {
    ...
    $.get("<?= site_url('dealer/users/get_custom_package/') ?>" + <?= $stalker->id; ?>, function(data) {
        const res = JSON.parse(data);    
