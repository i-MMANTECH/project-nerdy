    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed <?= ($is_user=="users") ? 'page-sidebar-menu-closed': ''; ?> " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="sidebar-search-wrapper">
                ...
                <?php echo form_open('dealer/users/index',array('class'=>'sidebar-search','method'=>'get')); ?>
        ...
        <li class="nav-item start <?= ($active_uri=='dashboard') ? 'active open': '';?>">
            <a href="<?php echo site_url('dealer/dashboard'); ?>" class="nav-link nav-toggle">
                <i class="icon-home"></i>
        ...
        <li class="nav-item start <?= ($active_uri=='check_mac') ? 'active open': '';?>">
            <a href="<?php echo site_url('dealer/check_mac'); ?>" class="nav-link nav-toggle">
        ...
        <li class="nav-item  <?= ($active_uri=='users') ? 'active open': '';?>">
            <a href="<?php echo site_url('dealer/users/index')?>" class="nav-link nav-toggle">
        ...
        <li class="nav-item <?= ($active_uri=='transactions') ? 'active open': '';?>">
            <a href="<?php echo site_url('dealer/transactions'); ?>" class="nav-link nav-toggle">
        ...
        <li class="nav-item <?= ($active_uri=='message') ? 'active open': '';?>">
            <a href="<?php echo site_url('dealer/message/index'); ?>" class="nav-link nav-toggle">
