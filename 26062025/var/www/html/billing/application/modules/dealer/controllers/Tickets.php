...
class Tickets extends DealerController {
	...
	public function index() {
		...
		$did = $this->dealer_model->dealer_id($this->user['username']);
	...
	public function create() {
		...
		if ($this->form_validation->run() == TRUE) {
			...
			redirect(site_url('dealer/tickets'), 'refresh');
	...
	public function comment() {
		...
		if ($this->form_validation->run() == TRUE) {
			...
			if ($this->db->insert('tickets_comments', $comment_data)) {
				...
				redirect(site_url('dealer/tickets/view/' . $redirect), 'refresh');
			}
		}
	}
	...
	public function dashboard() {
		...
		$this->load->view('dealer/tickets_dashboard', $data);
	}
